...
def search_tf_idf(query, index):
    query = text_processing.cleanText(query)
...
index, tf, df, idf = create_index_tfidf(text_processing.all_tweets, len(text_processing.all_tweets), text_processing.json_data)
